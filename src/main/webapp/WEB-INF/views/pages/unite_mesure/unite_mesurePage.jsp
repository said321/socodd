        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/unite_mesure/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                                ...
                                <tbody>
                                	<c:forEach items="${unite_mesures }" var = "unite">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>${unite.getNom() }</td>
	                                        <td>
	                                        	<c:url value="/unite_mesure/modifier/${unite.getId() }" var="urlModif" />
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/unite_mesure/supprimer/${unite.getId() }" var="urlSuppression" />
