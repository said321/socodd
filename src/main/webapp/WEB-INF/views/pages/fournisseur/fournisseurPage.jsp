        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/u/fournisseur/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach items="${fournisseurs }" var = "fournisseur">
	                                    <tr class="odd gradeX">
	                                        <td >${fournisseur.getCode() }</td>
	                                        <td>${fournisseur.getNom() }</td>
	                                        <td>${fournisseur.getTypeFournisseur().getNom() }</td>
	                                        <td>${fournisseur.getAdresse() }</td>
	                                        <td>${fournisseur.getTelephone() }</td>
	                                        <td>${fournisseur.getFax() }</td>
	                                        <td>${fournisseur.getDateEntree() }</td>
	                                        <td>${fournisseur.getNumCompteTiers() }</td>
	                                        <td>
	                                        	<c:url value="/u/fournisseur/modifier/${fournisseur.getId() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalFournisseur${fournisseur.getId() }"><i class="fa fa-trash-o"></i></a>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/u/fournisseur/supprimer/${fournisseur.getId() }" var="urlSuppression" />
