	...
	<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.fournisseur.titre" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        <div class="panel-heading">
	                            <fmt:message code="common.fournisseur.soustitre1" />
	                        </div>
	                        <!-- /.panel-heading -->
	                        <div class="panel-body">
	                        	<c:url value="/u/fournisseur/enregistrer" var ="urlEnregistrer" />
								<f:form modelAttribute="fournisseur" action="${urlEnregistrer }" role = "form">
									...
									<div class="form-group">
		                                ...
		                                <div class="form-group"> 
		                                    <label>Select Type de Fournisseur</label>
		                                    <select name="t_four_id" class = "form-control" >
		                                    	<option value = "${fournisseur.getTypeFournisseur().getId() }">${fournisseur.getTypeFournisseur().getNom() }</option>
		                                    	<c:forEach items = "${typeFournisseurs }" var = "typeFournisseur">
		                                    		<c:if test="${fournisseur.getTypeFournisseur().getId()!=typeFournisseur.getId() }"> 
			                            ...
			                            <div class="form-group">
				                            <label>Date Entrée</label>
			                               	<input name="date_entree" value="${fournisseur.getDateEntree() }" type="date" class="form-control" required/> 
			                            </div>
			                            
										<div class="form-group">
		                                    <label>Import B.I.C</label>
		                                    <select name="import_bic" class = "form-control" >
		                                    	<c:if test="${fournisseur.getNumBic() == 'assujeti' }">
		                                    		<option value = "${fournisseur.getNumBic() }">Assujeti</option>
		                                    		<option value = "exonore">Exonoré</option>
		                                    	</c:if>
		                                    	<c:if test="${fournisseur.getNumBic() == 'exonore' }">
		                                    		<option value = "${fournisseur.getNumBic() }">Exonoré</option>
									...
									<div class="form-group">
                                        ...
                                        <f:input path="numCompteTiers" class="form-control" placeholder="123..." required="true"/>
                                    </div>
									...
									<div class="form-group">
		                                ...
		                                <div class="form-group"> 
		                                    <label>Banque</label>
		                                    <select name="t_four_id" class = "form-control" >
		                                    	<option value = "${fournisseur.getBanque().getId() }">${fournisseur.getBanque().getNom() }</option>
	                                ...
	                                <div class="panel-footer">
                                    	...
                                    	<a href="<c:url value="/u/fournisseur/" />" class="btn btn-danger"> <i class="fa fa-arrow-left">&nbsp;<fmt:message code="common.annuler" /></i></a>
                                    </div>
								</f:form>	                        
	                        </div>
	                        <!-- /.panel-body -->
