        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/u/sousPrefecture/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="common.sousPrefecture.soustitre1" />
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                	<c:forEach items="${sousPrefectures }" var = "sousPrefecture">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	<c:url value="/u/sousPrefecture/modifier/${sousPrefecture.getId() }" var="urlModif" />
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/u/sousPrefecture/supprimer/${sousPrefecture.getId() }" var="urlSuppression" />
