    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.typeCalcule.titre" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/u/typeCalcule/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="common.typeCalcule.soustitre1" />
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                	<c:forEach items="${typeCalcules }" var = "typeCalcule">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	<c:url value="/u/typeCalcule/modifier/${typeCalcule.getId() }" var="urlModif" />
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/u/typeCalcule/supprimer/${typeCalcule.getId() }" var="urlSuppression" />
