	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        <div class="panel-heading">
	                            <fmt:message code="common.employee.soustitre2" />
	                        </div>
	                        <!-- /.panel-heading -->
	                        <div class="panel-body">
	                        	<c:url value="/u/employee/enregistrer" var ="urlEnregistrer" />
								<f:form modelAttribute="employee" action="${urlEnregistrer }" role = "form">
									...
									<div class="form-group">
										...
										<div class="form-group">
		                                    ...
		                                    <select name="nationalite_id" class = "form-control" >
		                                    	<option value = "1">Select Nationalité</option>
										...
										<div class="form-group">
		                                    ...
		                                    <select name="equipe_id" class = "form-control" >
		                                    	<option value = "1">Select Equipe</option>
	                                ...
	                                <div class="panel-footer">
                                    	...
                                    	<a href="<c:url value="/u/employee/" />" class="btn btn-danger"> <i class="fa fa-arrow-left">&nbsp;<fmt:message code="common.annuler" /></i></a>
                                    </div>
								</f:form>	                        
	                        </div>
	                        <!-- /.panel-body -->
