	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/u/usine/enregistrer" var ="urlEnregistrer" />
								<f:form modelAttribute="usine" action="${urlEnregistrer }" role = "form">
									<f:hidden path="id"/>
									<f:hidden path="code"/>
	                               ...
	                               <c:if test="${ttt=='modifier' }"> 
		                                <div class="form-group">
		                                    <label>Localite</label>
		                                    <select name="loc_id" class = "form-control" id="listLocalites">
		                                    	<option value = "${usine.getLocalite().getId() }">${usine.getLocalite().getNom() }</option>
		                                    	<c:forEach items = "${usines }" var = "usine">
		                                    		<c:if test="${usine.getLocalite().getId()!=usine.getId() }"> 
		                                    			<option value = "${usine.getId() }">${usine.getNom() }</option>
		                                    		</c:if>
		                                    	</c:forEach>
		                                    </select>
		                                </div>
	                                ...
	                                <div class="panel-footer">
                                    	...
                                    	<a href="<c:url value="/u/usine/" />" class="btn btn-danger"> <i class="fa fa-arrow-left">&nbsp;<fmt:message code="common.annuler" /></i></a>
                                    </div>
