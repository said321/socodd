    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.typeFournisseur" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="typeFournisseur.liste" />
                        </div>
                        <!-- /.panel-heading -->
                                	...
                                	<c:forEach items="${typeFournisseurs }" var = "typeFournisseur">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	...
	                                        	<div class="modal fade" id="modalTypeFournisseur${typeFournisseur.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="typeFournisseur.confirm.suppression.msg" />
															</div>
