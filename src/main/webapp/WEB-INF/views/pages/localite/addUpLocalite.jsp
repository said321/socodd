	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        ...
	                        <div class="panel-body">
	                        	<c:url value="/u/localite/enregistrer" var ="urlEnregistrer" />
								<f:form modelAttribute="localite" action="${urlEnregistrer }" role = "form">
									<f:hidden path="id"/>
									<f:hidden path="code"/>
	                               ...
	                               <c:if test="${ttt=='modifier' }"> 
	                                ...
	                                <div class="panel-footer">
                                    	...
                                    	<a href="<c:url value="/u/localite/" />" class="btn btn-danger"> <i class="fa fa-arrow-left">&nbsp;<fmt:message code="common.annuler" /></i></a>
                                    </div>
								</f:form>	                        
	                        </div>
	                        <!-- /.panel-body -->
