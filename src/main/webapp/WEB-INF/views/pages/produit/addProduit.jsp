	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        <div class="panel-heading">
	                            <fmt:message code="common.soustitre2" />
	                        </div>
	                        <!-- /.panel-heading -->
	                        <div class="panel-body">
								...
								<f:form modelAttribute="produit" action="${urlEnregistrer }" role = "form">
									...
									<div class="form-group">
                                        ...
                                        <f:input path="prixAchatIndicatif" class="form-control" placeholder="00.00" required="true" />
                                    </div>   
                                    
									<div class="form-group">
                                        <label>Prix de vente</label>
                                        <f:input path="prixVenteIndicatif" class="form-control" placeholder="00.00" required="true" />
                                    </div>

									<div class="form-group">
                                        <label>Poids</label>
                                        <f:input path="poidsTheorique" class="form-control" placeholder="00.00" required="true" />
                                    </div>
