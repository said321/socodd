                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="produit.liste" />
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                	<c:forEach items="${produits }" var = "produit">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>${produit.getTypeSacBySacBrousse().getNom() }</td>
	                                        ...
	                                        <td>
	                                        	...
	                                        	<div class="modal fade" id="modalProduit${produit.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="produit.confirm.suppression.msg" />
															</div>
