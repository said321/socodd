    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.prefecture" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="prefecture.liste" />
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach items="${prefectures }" var = "prefecture">
	                                    <tr class="odd gradeX">
	                                        <td >${prefecture.getCode() }</td>
	                                        <td>${prefecture.getNom() }</td>
	                                        <td>${prefecture.getRegion().getNom() }</td>
	                                        ...
	                                        <td>
	                                        	...
	                                        	<div class="modal fade" id="modalPrefecture${prefecture.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="prefecture.confirm.suppression.msg" />
															</div>
