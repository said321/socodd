        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/u/client/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                                ...
                                <tbody>
                                	<c:forEach items="${clients }" var = "client">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>${client.getNom() }</td>
	                                        <td>${client.getTypeClient().getNom() }</td>
	                                        <td>${client.getAdresse() }</td>
	                                        <td>${client.getTelephone() }</td>
	                                        <td>${client.getFax() }</td>
	                                        <td>${client.getDateEntree() }</td>
	                                        <td>${client.getNumCompteTiers() }</td>
	                                        <td>
	                                        	<c:url value="/u/client/modifier/${client.getId() }" var="urlModif" />
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/u/client/supprimer/${client.getId() }" var="urlSuppression" />
