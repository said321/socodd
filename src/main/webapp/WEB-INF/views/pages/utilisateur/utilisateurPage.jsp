        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/p/utilisateur/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach items="${utilisateurs }" var = "utilisateur">
	                                    <tr class="odd gradeX">
	                                        <td>${utilisateur.getCode() }</td>
	                                        <td>${utilisateur.getNom() }</td>
	                                        <td>${utilisateur.getPrenom() }</td>
	                                        <td>${utilisateur.getProfileUtilisateur().getNom() }</td>
	                                        <td>${utilisateur.isActive() }</td>
	                                        <td>
	                                        	<c:url value="/p/utilisateur/modifier/${utilisateur.getId() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalUtilisateur${utilisateur.getId() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalUtilisateur${utilisateur.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/p/utilisateur/supprimer/${utilisateur.getId() }" var="urlSuppression" />
