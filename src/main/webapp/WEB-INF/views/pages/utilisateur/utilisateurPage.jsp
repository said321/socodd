                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="utilisateur.liste" />
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                	<c:forEach items="${utilisateurs }" var = "utilisateur">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	<c:url value="/utilisateur/modifier/${utilisateur.getId() }" var="urlModif" />
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="utilisateur.confirm.suppression.msg" />
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message code="common.annuler" /></button>
																<c:url value="/utilisateur/supprimer/${utilisateur.getId() }" var="urlSuppression" />
